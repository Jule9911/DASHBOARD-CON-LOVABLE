...
def main():
    st.title("DASHBOARD MONITOREO GENERADOR")
    st.markdown("---")
...
def show_recommendations(current_row, model, feature_columns, target_columns):
    ...
    if active_faults:
        ...
        data = {
            "Parámetro": ["Filtros", "Inyectores", "Turbo", "Válvulas", "Aceite", "Refrigerante"],
            "Años/Meses": ["6 meses", "1 o 2 años", "5 años", "5 años", "6 meses", "2 años"],
            "Horas": ["250 h", "1000 h", "2000 h", "2000 h", "250 h", "1000 h"],
            "Fallas": [
                "Falla de filtros o falla de motor",
                "Consumo de combustible, daño de cámara, daño de sellos, falla de inyectores, daño de válvulas",
                "Pérdida de aceite, potencia, daño de máquina",
                "Pérdida de compresión, recalentamiento de escape, exceso de consumo de combustible",
                "Ruptura de biela, daño de cilindro, ruptura de cigüeñal, ruptura de árbol de levas, daño de retenedor delantero y posterior",
                "Daño de radiador, deterioro de bandas, obstrucción del sistema de enfriamiento, incremento de temperatura del motor, daño de sello de válvula, daño de empaquetadura de cárter"
            ],
            "Acción Recomendada": ["" for _ in range(6)]
        }
